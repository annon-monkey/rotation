...
{
    public interface IReverseFunction
    {
    ...
    /// 一定間隔でオンオフを繰り返す
    /// </summary>
    public class RegularReverseFunction : IReverseFunction
    {
        /// <summary>
    ...
    /// </summary>
    public class LineReverseFunction : IReverseFunction
    {
        /// <summary>
    ...
    public class RandomReverseFunction : IReverseFunction
    {
